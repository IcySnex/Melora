...
internal partial class YouTubeWrapper
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return new DownloadableTrack(
            ...
            copyright: $"{searchResult.Title} - {searchResult.Artists} ℗ {video.UploadDate.Year}, Provided to YouTube, Auto-generated by Musify.PlatformSupport.YouTube.YouTubePlugin",
            comment: "Downloaded with Musify, Musify.PlatformSupport.YouTube.YouTubePlugin",
