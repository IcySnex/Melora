...
internal partial class YouTubeMusicWrapper
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return new DownloadableTrack(
            ...
            copyright: $"{searchResult.Title} - {searchResult.Artists} ℗ {songVideo.UploadedAt.Year}, Provided to YouTube Music, Auto-generated by Musify.PlatformSupport.YouTube.YouTubeMusicPlugin",
            comment: "Downloaded with Musify, Musify.PlatformSupport.YouTube.YouTubeMusicPlugin",
