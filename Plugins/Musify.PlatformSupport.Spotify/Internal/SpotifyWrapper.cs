...
internal partial class SpotifyWrapper
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return new DownloadableTrack(
            ...
            copyright: $"{searchResult.Title} - {searchResult.Artists} ({albumName}) ℗ {releaseDate.Year}, Provided to Spotify, Auto-generated by Musify.PlatformSupport.Spotify.SpotifyPlugin",
            comment: "Downloaded with Musify, Musify.PlatformSupport.Spotify.SpotifyPlugin",
